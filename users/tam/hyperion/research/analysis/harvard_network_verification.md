...
4. **2nd-degree vs 1st-degree:** The CSV shows "2nd degree" for all connections, which may indicate:
   - These are connections of connections (not direct connections)
   - OR LinkedIn API limitation showing all as "2nd degree"
...
3. 🚩 **Both verified connections are 2nd-degree**, not 1st-degree
